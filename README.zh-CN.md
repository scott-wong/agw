...
| 交付物 | 名称 | 说明 |
|--------|------|------|
| RPM（EL8） | `agw-3.18.0-agw.1.el8.x86_64.rpm` | 唯一 RPM；不交付 `apisix-runtime` / `apisix` 中间包 |
| 镜像 | `ghcr.io/scott-wong/agw:3.18.0-agw.1` | 标签 `3.18.0-agw.1`（不可移动）、`3.18.0`、`latest` |
...
packaging/docker/       Anolis 8.10 交付镜像
